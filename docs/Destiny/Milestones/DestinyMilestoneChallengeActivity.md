...
**challenges** | [**list[DestinyChallengeStatus]**](DestinyChallengeStatus.md) |  | [optional] 
...
**phases** | [**list[DestinyMilestoneActivityPhase]**](DestinyMilestoneActivityPhase.md) | If the Activity has discrete \&quot;phases\&quot; that we can track, that info will be here. Otherwise, this value will be NULL. Note that this is a list and not a dictionary: the order implies the ascending order of phases or progression in this activity. | [optional] 
