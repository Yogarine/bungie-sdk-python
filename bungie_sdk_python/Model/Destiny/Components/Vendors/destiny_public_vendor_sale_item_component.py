...
class DestinyPublicVendorSaleItemComponent(object):
    ...
    def __init__(self, vendor_item_index=None, item_hash=None, override_style_item_hash=None, quantity=None, costs=None, override_next_refresh_date=None):  # noqa: E501
        """DestinyPublicVendorSaleItemComponent - a model defined in OpenAPI"""  # noqa: E501
    ...
    def vendor_item_index(self):
        """Gets the vendor_item_index of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        ...
        :return: The vendor_item_index of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :rtype: int
        """
    ...
    def vendor_item_index(self, vendor_item_index):
        """Sets the vendor_item_index of this DestinyPublicVendorSaleItemComponent.

        The index into the DestinyVendorDefinition.itemList property. Note that this means Vendor data *is* Content Version dependent: make sure you have the latest content before you use Vendor data, or these indexes may mismatch.   Most systems avoid this problem, but Vendors is one area where we are unable to reasonably avoid content dependency at the moment.  # noqa: E501

        :param vendor_item_index: The vendor_item_index of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :type: int
        """
    ...
    @property
    def item_hash(self):
        """Gets the item_hash of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        ...
        :return: The item_hash of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :rtype: int
        """
    ...
    def item_hash(self, item_hash):
        """Sets the item_hash of this DestinyPublicVendorSaleItemComponent.

        The hash of the item being sold, as a quick shortcut for looking up the DestinyInventoryItemDefinition of the sale item.  # noqa: E501

        :param item_hash: The item_hash of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :type: int
        """
    ...
    def override_style_item_hash(self):
        """Gets the override_style_item_hash of this DestinyPublicVendorSaleItemComponent.  # noqa: E501

        If populated, this is the hash of the item whose icon (and other secondary styles, but *not* the human readable strings) should override whatever icons/styles are on the item being sold.  If you don't do this, certain items whose styles are being overridden by socketed items - such as the \"Recycle Shader\" item - would show whatever their default icon/style is, and it wouldn't be pretty or look accurate.  # noqa: E501

        :return: The override_style_item_hash of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :rtype: int
        """
    ...
    def override_style_item_hash(self, override_style_item_hash):
        """Sets the override_style_item_hash of this DestinyPublicVendorSaleItemComponent.

        If populated, this is the hash of the item whose icon (and other secondary styles, but *not* the human readable strings) should override whatever icons/styles are on the item being sold.  If you don't do this, certain items whose styles are being overridden by socketed items - such as the \"Recycle Shader\" item - would show whatever their default icon/style is, and it wouldn't be pretty or look accurate.  # noqa: E501

        :param override_style_item_hash: The override_style_item_hash of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :type: int
        """
    ...
    @property
    def quantity(self):
        """Gets the quantity of this DestinyPublicVendorSaleItemComponent.  # noqa: E501

        How much of the item you'll be getting.  # noqa: E501

        :return: The quantity of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this DestinyPublicVendorSaleItemComponent.

        How much of the item you'll be getting.  # noqa: E501

        :param quantity: The quantity of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :type: int
        """
    ...
    @property
    def costs(self):
        """Gets the costs of this DestinyPublicVendorSaleItemComponent.  # noqa: E501

        A summary of the current costs of the item.  # noqa: E501

        :return: The costs of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
    ...
    def costs(self, costs):
        """Sets the costs of this DestinyPublicVendorSaleItemComponent.

        A summary of the current costs of the item.  # noqa: E501

        :param costs: The costs of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
    ...
    def override_next_refresh_date(self):
        """Gets the override_next_refresh_date of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        ...
        :return: The override_next_refresh_date of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :rtype: datetime
        """
    ...
    def override_next_refresh_date(self, override_next_refresh_date):
        """Sets the override_next_refresh_date of this DestinyPublicVendorSaleItemComponent.

        If this item has its own custom date where it may be removed from the Vendor's rotation, this is that date.  Note that there's not actually any guarantee that it will go away: it could be chosen again and end up still being in the Vendor's sale items! But this is the next date where that test will occur, and is also the date that the game shows for availability on things like Bounties being sold. So it's the best we can give.  # noqa: E501

        :param override_next_refresh_date: The override_next_refresh_date of this DestinyPublicVendorSaleItemComponent.  # noqa: E501
        :type: datetime
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DestinyPublicVendorSaleItemComponent):
            return False
